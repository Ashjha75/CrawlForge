...
<div class="signin-container">
    <div class="signin-card">
        ...
        <form class="signin-form" id="signinForm" method="POST" action="${pageContext.request.contextPath}/authenticate" data-dashboard-url="${pageContext.request.contextPath}/dashboard">
