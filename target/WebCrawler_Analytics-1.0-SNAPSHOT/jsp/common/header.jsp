...
<style>
    /* Enhanced Header Styles - Polished with Glass Effect */
    .navbar-custom {
    ...
    .navbar-custom.scrolled {
        background: linear-gradient(135deg,
        rgba(31, 31, 43, 0.95) 0%,
        rgba(44, 44, 58, 0.98) 50%,
        rgba(64, 65, 79, 0.95) 100%);
    ...
    /* Brand Styling with Glass Effect */
    .navbar-brand {
        font-size: 1.4rem;
        font-weight: 700;
        ...
        box-shadow:
                0 4px 15px rgba(16, 163, 127, 0.1),
                inset 0 1px 0 rgba(255, 255, 255, 0.1);
    ...
    .navbar-brand::before {
        ...
        transparent 0%,
        rgba(16, 163, 127, 0.2) 30%,
        rgba(16, 163, 127, 0.3) 50%,
        rgba(16, 163, 127, 0.2) 70%,
        transparent 100%);
    ...
    .navbar-brand:hover {
        color: #0d8465 !important;
        transform: translateY(-1px);
        background: linear-gradient(135deg,
        rgba(16, 163, 127, 0.15) 0%,
        rgba(16, 163, 127, 0.1) 100%);
        box-shadow:
                0 6px 20px rgba(16, 163, 127, 0.2),
                inset 0 1px 0 rgba(255, 255, 255, 0.15);
    }
    ...
    /* Linear Gradient Animation with Glass Effect */
    .nav-link::before {
        content: '';
        position: absolute;
        top: 0;
    ...
    .nav-link:hover {
        ...
        box-shadow:
                0 6px 20px rgba(16, 163, 127, 0.15),
                inset 0 1px 0 rgba(255, 255, 255, 0.1);
    ...
    .nav-link.active {
        ...
        rgba(16, 163, 127, 0.15) 50%,
        rgba(16, 163, 127, 0.1) 100%);
        border: 1px solid rgba(16, 163, 127, 0.4);
        box-shadow:
                0 4px 15px rgba(16, 163, 127, 0.2),
                inset 0 1px 0 rgba(255, 255, 255, 0.15);
    ...
    /* Notification Badge - Fixed and Visible */
    .nav-item {
        position: relative;
    }
    ...
    /* Mobile Toggle Button with Glass Effect */
    .navbar-toggler {
        border: 1px solid rgba(16, 163, 127, 0.3);
    ...
    .navbar-toggler-icon {
        background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3e%3cpath stroke='rgba%2816, 163, 127, 1%29' stroke-linecap='round' stroke-miterlimit='10' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e");
    }
