...
public class User {
    ...
    @Column(name = "user_id")
    @Setter(AccessLevel.NONE) // Prevent setting ID manually
    private Long userId;
    ...
    @Setter(AccessLevel.PACKAGE) // Only allow package-level access
    ...
    @Setter(AccessLevel.NONE) // Prevent manual setting
    ...
    // Relationships - Excluded from toString to avoid lazy loading issues
    ...
    // Manual equals and hashCode for JPA entities (Lombok best practice)
    @Override
