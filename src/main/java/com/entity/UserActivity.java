...
public class UserActivity {
    ...
    public static UserActivity empty(Long userId) {
        return UserActivity.builder()
                ...
                .personalBestSuccessRate(0.0)
                .totalLinksDiscovered(0L)
                .totalKeywordsExtracted(0L)
                .totalCrawlingTimeMinutes(0L)
                .averageSessionDurationMinutes(0.0)
                .longestSessionDurationMinutes(0L)
                .shortestSessionDurationMinutes(0L)
                .uniqueDomainsExplored(0)
                .mostCrawledDomain(null)
                .mostCrawledDomainCount(0L)
                .activityPatternJson(null)
                .hourlyDistributionJson(null)
                .weeklyPatternJson(null)
                .monthlyTrendJson(null)
                .recentSessionsJson(null)
                .achievementsJson(null)
                .preferencesJson(null)
                .frequentSeedUrlsJson(null)
                .customSettingsJson(null)
                .productivityScore(0.0)
                .productivityGrade("N/A")
                .productivityInsightsJson(null)
                .loginAttempts(0)
                .emailVerified(false)
